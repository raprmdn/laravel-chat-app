...
export default function RightSideBoxChat({ message, isFirstMessage }) {
        ...
        <>
            ...
            <div className="col-start-6 col-end-13 p-1">
                <div className="relative flex flex-row-reverse">
                    <div className="py-2 pl-3 pr-3 text-xs text-gray-300 bg-gray-800 rounded-md lg:pr-20 lg:text-sm">
