    ...
    return (
        <>
            <form className="flex items-center flex-1">
                ...
                <button type="button" className="flex items-center justify-center w-8 h-8 lg:w-10 lg:h-10 -mt-1 text-gray-500 transition duration-150 rotate-45 rounded-full hover:text-gray-400 focus:outline-none">
